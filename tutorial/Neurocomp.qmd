...
![Source: @Kriegeskorte2018a](../slides/img/neurocomp.png)
...
![](../slides/img/ratecoded-simple.png)
...
![](../slides/img/rc-network.jpg)

:::
::: {.column}

![](../slides/img/reservoir-simple.png)
...
With rate-ocded networks, you can use virtually anything virtually any learning rule depending only on the pre- and post-synaptic firing rates, e.g. in @Vitay2010:
...
![Source: @Bi2001](../slides/img/stdp2.png){width=50%}
...
![Source: @Villagrasa2018](../slides/img/BG.png)
...
![Source: @Goenner2017](../slides/img/Hippocampus.png)
...
![Source: @Vitay2014](../slides/img/Dopamine.png)
