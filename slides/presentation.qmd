...
![Source: @Bi2001](img/stdp.jpg){width=70%}
...
Download the Jupyter notebook: [RC.ipynb](https://raw.githubusercontent.com/ANNarchy/ANNarchy-tutorial/master/webpage/notebooks/RC.ipynb){target="_blank"}

Run it directly on colab: [RC.ipynb](https://colab.research.google.com/github/ANNarchy/ANNarchy-tutorial/blob/master/webpage/notebooks/RC.ipynb){target="_blank"}
...
Download the Jupyter notebook: [BCM.ipynb](https://raw.githubusercontent.com/ANNarchy/ANNarchy-tutorial/master/webpage/notebooks/BCM.ipynb){target="_blank"}

Run it directly on colab: [BCM.ipynb](https://colab.research.google.com/github/ANNarchy/ANNarchy-tutorial/blob/master/webpage/notebooks/BCM.ipynb){target="_blank"}

::: {}
![Source: <http://www.scholarpedia.org/article/BCM_theory>](img/bcm.png){width=30%}
:::
...
Download the Jupyter notebook: [Miconi.ipynb](https://raw.githubusercontent.com/ANNarchy/ANNarchy-tutorial/master/webpage/notebooks/Miconi.ipynb){target="_blank"}

Run it directly on colab: [Miconi.ipynb](https://colab.research.google.com/github/ANNarchy/ANNarchy-tutorial/blob/master/webpage/notebooks/Miconi.ipynb){target="_blank"}

::: {}
![](img/miconi.png){width=100%}
:::
...
Download the Jupyter notebook: [AdEx.ipynb](https://raw.githubusercontent.com/ANNarchy/ANNarchy-tutorial/master/webpage/notebooks/AdEx.ipynb){target="_blank"}

Run it directly on colab: [AdEx.ipynb](https://colab.research.google.com/github/ANNarchy/ANNarchy-tutorial/blob/master/webpage/notebooks/AdEx.ipynb){target="_blank"}

![](img/adex.png){width=60%}
...
Download the Jupyter notebook: [SynapticTransmission.ipynb](https://raw.githubusercontent.com/ANNarchy/ANNarchy-tutorial/master/webpage/notebooks/SynapticTransmission.ipynb){target="_blank"}

Run it directly on colab: [SynapticTransmission.ipynb](https://colab.research.google.com/github/ANNarchy/ANNarchy-tutorial/blob/master/webpage/notebooks/SynapticTransmission.ipynb){target="_blank"}
...
Download the Jupyter notebook: [COBA.ipynb](https://raw.githubusercontent.com/ANNarchy/ANNarchy-tutorial/master/webpage/notebooks/CODA.ipynb){target="_blank"}

Run it directly on colab: [COBA.ipynb](https://colab.research.google.com/github/ANNarchy/ANNarchy-tutorial/blob/master/webpage/notebooks/COBA.ipynb){target="_blank"}

::: {}
![](img/COBA.png){width=40%}
:::
...
Download the Jupyter notebook: [STP.ipynb](https://raw.githubusercontent.com/ANNarchy/ANNarchy-tutorial/master/webpage/notebooks/STP.ipynb){target="_blank"}

Run it directly on colab: [STP.ipynb](https://colab.research.google.com/github/ANNarchy/ANNarchy-tutorial/blob/master/webpage/notebooks/STP.ipynb){target="_blank"}
...
Download the Jupyter notebook: [STDP.ipynb](https://raw.githubusercontent.com/ANNarchy/ANNarchy-tutorial/master/webpage/notebooks/STDP.ipynb){target="_blank"}

Run it directly on colab: [STDP.ipynb](https://colab.research.google.com/github/ANNarchy/ANNarchy-tutorial/blob/master/webpage/notebooks/STDP.ipynb){target="_blank"}
