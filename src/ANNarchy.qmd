...
There already exist several neuro-simulators for computational neuroscience, each which different levels of description (multi-compartmental, spiking, rate-coded, etc.) or supported hardware (CPU, GPU). 
