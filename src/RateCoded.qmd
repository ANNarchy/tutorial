...
In this section, we will take as an example an **Echo-State Network** (ESN), the rate-coded variant of **reservoir computing** introduced by @Jaeger2001. ESNs are recurrent neural networks with fixed recurrent weights. A linear readout is usually able to approximate any target signal based on the dynamic recurrent activity.
