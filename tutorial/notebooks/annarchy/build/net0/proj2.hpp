...
/////////////////////////////////////////////////////////////////////////////
// proj2: pop0 -> pop0 with target exc
/////////////////////////////////////////////////////////////////////////////
struct ProjStruct2 : LILInvMatrix<int, int> {
    ProjStruct2() : LILInvMatrix<int, int>( 500, 500) {
    }
        ...
        if (_transmission && pop0._active){
            ...
            for(int _idx_j = 0; _idx_j < pop0.spiked.size(); _idx_j++){
                ...
                for(int _idx_i = 0; _idx_i < nb_post; _idx_i++){
                    ...
                    pop0.g_exc[post_rank[i]] +=  u[i][j]*w[i][j]*x[i][j];
